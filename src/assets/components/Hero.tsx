...
import { ArrowRight, Download, Mail, Sparkles, Mouse } from "lucide-react";
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            ...
                            <br />
                            <br />
                            Je conçois des applications web robustes orientées
                            métier, de l'interface utilisateur jusqu'à l'API,
                            avec une attention particulière portée à
                            l'expérience utilisateur, à la qualité du code et à
                    ...
                    >
                        <button
                            ...
                            className="group glow flex-1 rounded-2xl bg-indigo-600 px-6 py-4 font-semibold text-white hover:bg-indigo-500 transition-all flex items-center justify-center gap-2"
                        >
